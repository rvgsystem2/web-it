        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{asset('asset/img/carousel-4.jpeg')}}" alt="Image">
...
<section class="wsus__property_page mt_45 mb_45">
  <div class="container">
    ...
    <li class="page-item"><a class="page-link" href="app_development.html?page_type=list_view&amp;page=2">2</a></li>

                    <li class="page-item">
                <a class="page-link" href="app_development.html?page_type=list_view&amp;page=2" aria-label="Next">
