        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{asset('asset/img/carousel-9 - Copy.jpg')}}" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">

                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Business Solution</h1>
  ...
  <div class="container">
    ...
    <nav aria-label="Page navigation example">
      <ul class="pagination">
            ...
            <li class="page-item"><a class="page-link" href="Business_solution.html?page_type=list_view&amp;page=2">2</a></li>

                    <li class="page-item">
                <a class="page-link" href="Business_solution.html?page_type=list_view&amp;page=2" aria-label="Next">
