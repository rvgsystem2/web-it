        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <!-- Post Job Modal -->
                    <div class="modal fade" id="postJobModal" tabindex="-1" aria-labelledby="postJobModalLabel"
                        aria-hidden="true">
                            ...
                            <div class="modal-content border-0 shadow-lg">
                                ...
                                <form id="jobPostingForm">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="jobDescription" class="form-label">Description <span
                                                    class="text-danger">*</span></label>
                                            <textarea class="form-control" id="jobDescription" name="jobDescription" rows="4"
                                                placeholder="Job responsibilities, skills required, etc." required></textarea>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="jobLocation"
                                                    name="jobLocation" placeholder="e.g. Remote, New York">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary rounded-pill px-4">Post
                                            Job</button>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="row g-4">
                            ...
                            <div class="job-card card h-100 shadow-sm">
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex mb-3">
                                        <img src="https://cdn.pixabay.com/photo/2023/02/01/00/54/company-7759278_1280.png" alt="TechWave"
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="job-card card h-100 shadow-sm">
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex mb-3">
                                        <img src="https://cdn.pixabay.com/photo/2023/02/01/00/54/company-7759278_1280.png" alt="Creativo"
                                            class="company-logo me-3">
                                        <div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="job-card card h-100 shadow-sm">
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex mb-3">
                                        <img src="https://cdn.pixabay.com/photo/2023/02/01/00/54/company-7759278_1280.png" alt="BuzzHub"
                                            class="company-logo me-3">
                                        <div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="job-card card h-100 shadow-sm">
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex mb-3">
                                        <img src="https://cdn.pixabay.com/photo/2023/02/01/00/54/company-7759278_1280.png" alt="DataSphere"
                                            class="company-logo me-3">
                                        <div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="job-card card h-100 shadow-sm">
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex mb-3">
                                        <img src="https://cdn.pixabay.com/photo/2023/02/01/00/54/company-7759278_1280.png" alt="CloudNine"
                                            class="company-logo me-3">
                                        <div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="job-card card h-100 shadow-sm">
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex mb-3">
                                        <img src="https://cdn.pixabay.com/photo/2023/02/01/00/54/company-7759278_1280.png" alt="AppVantage"
                                            class="company-logo me-3">
                                        <div>
