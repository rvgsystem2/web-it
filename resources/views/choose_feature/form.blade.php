        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h2 class="text-xl font-semibold mb-4">
                    {{ isset($feature) ? 'Edit Choose Feature' : 'Add Choose Feature' }}
                </h2>
                ...
                <form action="{{ isset($feature) ? route('choose-features.update', $feature->id) : route('choose-features.store') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="icon" value="{{ old('icon', $feature->icon ?? '') }}"
                            class="w-full px-4 py-2 border rounded-lg focus:ring focus:ring-blue-200"
                            placeholder="e.g. fa fa-star or custom icon class">
                    </div>
